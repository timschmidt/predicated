...
pub use crate::predicates::orient::{
    ...
    Line2Orientation, Line2OrientationQuery, PredicateFacts, Sphere3Polynomial,
    classify_point_line_with_orientation_and_policy as classify_point_line_with_orientation,
    classify_point_line_with_orientation_and_query_and_policy as classify_point_line_with_orientation_and_query,
    ...
    insphere3d_with_policy as insphere3, line2_orientation, line2_orientation_query,
    line2_orientation_with_facts, orient2d_with_policy as orient2, orient3d_with_policy as orient3,
};
